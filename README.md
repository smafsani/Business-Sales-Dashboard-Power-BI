...
- Trend analysis across different weeks and stores
- Holiday vs Non-Holiday sales comparison
- Economic factor relations: Temperature, Fuel Price, CPI, Unemployment
- Slicers for Date & Store filtering
...
- Do economic factors correlate with sales?
...
- Integrate LLM for automated report summary
